...
export default function FormProduto() {
  ...
  const mostrarBotoes = () => {
    var btn1 = (
      <button className="formButton" onClick={cadastrarProduto}>
        Cadastrar Produto
      </button>
    );
    var btn2 = (
      <>
        <button className="formButton" onClick={editarProduto}>
          Editar Produto
        </button>
        <button className="formButton" onClick={deletarProduto}>
          Excluir Produto
        </button>
      </>
    );
    ...
    <div>
      <div className="regArea">
        ...
        <div>
          <Link
            title="Home"
            to={"/meusProdutos/" + produto.cdEstab}
            className="produtosBtn"
          >
            Meus Produtos
          </Link>
        </div>
