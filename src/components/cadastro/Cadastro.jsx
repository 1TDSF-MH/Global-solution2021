...
export default function Cadastro() {
  ...
  const cadastroOng = () => {
    ...
    if (
      cnpj.isValid(cnpjOng) &&
      validator.isEmail(emailOng) &&
      cadastroValido &&
      cadastro.senha.length <= 6
    ) {
  ...
  const formEntidade = () => {
    setFormulario(
      <div>
        <p className="text">
          Se você deseja retirar produtos, faça o cadastro de sua ONG.
        </p>
        <div className="formArea" style={{ marginLeft: 0 }}>
          ...
          <input
            ...
            onChange={verificaEmailONG}
          />
          <input
            id="senhaOng"
            className="formCadastro"
            type="password"
            placeholder="senha (até 6 dígitos)"
            onChange={verificaSenhaONG}
          />
          <input
            id="responsavelOng"
            className="formCadastro"
          ...
          />
          <button className="formbutton" onClick={cadastroOng}>
            Cadastrar
          </button>
        </div>
      </div>
  ...
  const formEmpresa = () => {
    setFormulario(
      <div>
        <p className="text">
          Se você deseja cadastrar produtos para que sejam retirados por ONGs,
          faça o cadastro do seu estabelecimento.
        </p>
        <div className="formArea" style={{ marginLeft: 0 }}>
          <input
            id="cnpjEmpresa"
          ...
          <button className="formbutton" onClick={cadastroEmpresa}>
            Cadastrar
          </button>
        </div>
      </div>
  ...
  return (
    <div>
      ...
      <div className="btnArea">
        <button onClick={formEntidade} className="btn1">
          ONG
        </button>
        <button onClick={formEmpresa} className="btn2">
          Empresa
        </button>
      </div>
      <div style={{ marginBottom: 20 }}>{formulario}</div>
      <div>
